...
async function main() {
    ...
    const mongoDbHero = new Context(new MongoDB(connection, HeroSchema))
    ...
    app.route([
        ...
        ...mapRoutes(new HeroRoutes(mongoDbHero), HeroRoutes.methods()),
        ...mapRoutes(new AuthRoutes(MINHA_CHAVE_SECRETA, mongoDbUser), AuthRoutes.methods())
    ])
